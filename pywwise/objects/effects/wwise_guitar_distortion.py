...
from pywwise.enums import EGuitarDistortionType, EGuitarDistortionEqType
...
class WwiseGuitarDistortion(WwiseObject):
    ...
    post_eq_band1_type = WwiseProperty[EGuitarDistortionEqType]("PostEQBand1FilterType", EGuitarDistortionEqType)
    ...
    post_eq_band2_type = WwiseProperty[EGuitarDistortionEqType]("PostEQBand2FilterType", EGuitarDistortionEqType)
    ...
    post_eq_band3_type = WwiseProperty[EGuitarDistortionEqType]("PostEQBand3FilterType", EGuitarDistortionEqType)
    ...
    pre_eq_band1_type = WwiseProperty[EGuitarDistortionEqType]("PreEQBand1FilterType", EGuitarDistortionEqType)
    ...
    pre_eq_band2_type = WwiseProperty[EGuitarDistortionEqType]("PreEQBand2FilterType", EGuitarDistortionEqType)
    ...
    pre_eq_band3_type = WwiseProperty[EGuitarDistortionEqType]("PreEQBand3FilterType", EGuitarDistortionEqType)
