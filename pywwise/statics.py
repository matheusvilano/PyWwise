...
class StringStatics(metaclass=StaticMeta):
    ...
    def to_camel_case(text: str) -> str:
        ...
        """
        if _re_match(ECaseStyle.CAMEL, text):
            return text
    ...
    def to_kebab_case(text: str) -> str:
        ...
        """
        if _re_match(ECaseStyle.KEBAB, text):
            return text
        if _re_match(ECaseStyle.PASCAL, text) or _re_match(ECaseStyle.CAMEL, text):
            tokens = _re_findall(r"[A-Z]?[a-z]+|[A-Z]+(?=[A-Z]|$)", text)
        else:
            tokens = _re_split(r"[-_\s]", text)
    ...
    def to_pascal_case(text: str) -> str:
        ...
        """
        if _re_match(ECaseStyle.PASCAL, text):
            return text
    ...
    def to_snake_case(text: str) -> str:
        ...
        """
        if _re_match(ECaseStyle.SNAKE, text):
            return text
    ...
    def to_upper_case(text: str) -> str:
        ...
        """
        if _re_match(ECaseStyle.UPPER, text):
            return text
