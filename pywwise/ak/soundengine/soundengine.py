...
class SoundEngine:
	...
	def get_state(self, state_group: Name | ShortID | GUID | ProjectPath) -> tuple[str, str]:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_getstate.html \n
	...
	def get_switch(self, switch_group: Name | ShortID | GUID | ProjectPath, game_object: GameObjectID) -> tuple[
		str, str]:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_getswitch.html \n
	...
	def load_bank(self, sound_bank: Name | ShortID | GUID) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_loadbank.html \n
	...
	def post_event(self, event: Name | ShortID | GUID,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_postevent.html \n
	...
	def post_msg_monitor(self, message: str) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_postmsgmonitor.html \n
	...
	def post_trigger(self, trigger: Name | ShortID | GUID, game_object: GameObjectID = None) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_posttrigger.html \n
	...
	def register_game_obj(self, obj_id: GameObjectID, obj_name: Name) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_registergameobj.html \n
	...
	def reset_rtpc_value(self, rtpc: Name | GUID | ShortID, game_object: GameObjectID) -> bool:
		"""
		https://www.audiokinetic.comlibrary/2023.1.4_8496/?source=SDK&id=ak_soundengine_resetrtpcvalue.html \n
	...
	def seek_on_event(self, event: Name | GUID | ShortID, game_object: GameObjectID, position: int | float,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_seekonevent.html \n
	...
	def set_default_listeners(self, listeners: set[GameObjectID]) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setdefaultlisteners.html \n
	...
	def set_game_object_aux_send_values(self, game_obj: GameObjectID,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setgameobjectauxsendvalues.html \n
	...
	def set_game_object_output_bus_volume(self, emitter: GameObjectID, listener: GameObjectID,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setgameobjectoutputbusvolume.html \n
	...
	def set_listeners(self, emitter: GameObjectID, listeners: set[GameObjectID]) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setlisteners.html \n
	...
	def set_listener_spatialization(self, listener: GameObjectID, spatialized: bool, channel_config: ESpeakerBitMask,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setlistenerspatialization.html \n
	...
	def set_multiple_positions(self):
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setmultiplepositions.html \n
	...
	def set_object_obstruction_and_occlusion(self, emitter: GameObjectID, listener: GameObjectID,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setobjectobstructionandocclusion.html \n
	...
	def set_position(self, game_obj: GameObjectID, orientation_front: Vector3, orientation_top: Vector3,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setposition.html \n
	...
	def set_rtpc_value(self, rtpc: GUID | Name | ShortID, value: float,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setrtpcvalue.html \n
	...
	def set_scaling_factor(self, game_obj: GameObjectID, attenuation_scaling_factor: float) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setscalingfactor.html \n
	...
	def set_state(self, state_group: GUID | Name | ShortID, state_value: GUID | Name | ShortID) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setstate.html \n
	...
	def set_switch(self, switch_group: GUID | Name | ShortID, switch_value: GUID | Name | ShortID,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_setswitch.html \n
	...
	def stop_all(self, game_obj: GameObjectID):
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_stopall.html \n
	...
	def stop_playing_id(self, playing_id: PlayingID, transition_duration: int, fade_curve: int):
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_stopplayingid.html \n
	...
	def unload_bank(self, sound_bank: Name | ShortID | GUID) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_unloadbank.html \n
	...
	def unregister_game_obj(self, obj_id: int) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_soundengine_unregistergameobj.html \n
