...
class Project:
	...
	def close(self) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_console_project_close.html \n
	...
	def create(self, project_path: _Path,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_console_project_create.html \n
	...
	def open(self, project_path: _Path, is_migration_allowed: bool, auto_checkout: bool) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_console_project_open.html \n
