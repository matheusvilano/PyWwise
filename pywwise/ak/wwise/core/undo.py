...
class Undo:
	...
	def begin_group(self) -> bool:
		"""
		https://www.audiokinetic.com/en/library/edge/?source=SDK&id=ak_wwise_core_undo_begingroup.html \n
	...
	def cancel_group(self, undo: bool = False) -> bool:
		"""
		https://www.audiokinetic.com/en/library/edge/?source=SDK&id=ak_wwise_core_undo_cancelgroup.html \n
	...
	def end_group(self, display_name: str) -> bool:
		"""
		https://www.audiokinetic.com/en/library/edge/?source=SDK&id=ak_wwise_core_undo_endgroup.html \n
	...
	def redo(self) -> bool:
		"""
		https://www.audiokinetic.com/en/library/edge/?source=SDK&id=ak_wwise_core_undo_redo.html \n
	...
	def undo(self) -> bool:
		"""
		https://www.audiokinetic.com/en/library/edge/?source=SDK&id=ak_wwise_core_undo_undo.html \n
