...
class Commands:
	...
	def __init__(self, client: _WaapiClient):
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_ui_commands_executed.html
	...
	def get_commands(self) -> tuple[str, ...]:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_ui_commands_getcommands.html \n
	...
	def execute(self, command: ECommand,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_ui_commands_execute.html \n
	...
	def register(self, commands: set[CommandInfo]) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_ui_commands_register.html \n
	...
	def unregister(self, commands: set[CommandInfo | str]) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_ui_commands_unregister.html \n
