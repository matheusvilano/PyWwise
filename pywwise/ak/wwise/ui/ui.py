...
class UI:
    ...
    def get_selected_objects(self, return_options: set[_EReturnOptions] = None, platform: str = None,
                             language: str = None) -> tuple[tuple[_GUID, _Name, dict[_EReturnOptions, _Any]], ...] | None:
        """
        ...
        for result in results:
            ...
            options = {key: value for key, value in result.items() if key != _EReturnOptions.GUID.value and key != _EReturnOptions.NAME.value}
