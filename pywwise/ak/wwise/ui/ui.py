...
class UI:
	...
	def __init__(self, client: _WaapiClient):
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_ui_selectionchanged.html
	...
	def bring_to_foreground(self) -> bool:
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_ui_bringtoforeground.html \n
	...
	def capture_screen(self, view_name: str = None, view_selection_channel: int = None, capture_rect: Rect = None,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_ui_capturescreen.html \n
	...
	def get_selected_objects(self, return_options: set[EReturnOptions] = None, platform: str = None,
		...
		"""
		https://www.audiokinetic.comlibrary/edge/?source=SDK&id=ak_wwise_ui_getselectedobjects.html \n
