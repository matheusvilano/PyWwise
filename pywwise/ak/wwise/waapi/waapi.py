...
class Waapi:
    ...
    def get_functions(self) -> tuple[str, ...]:
        """
        https://www.audiokinetic.com/en/library/edge/?source=SDK&id=ak_wwise_waapi_getfunctions.html \n
    ...
    def get_schema(self, uri: str) -> dict | None:
        """
        https://www.audiokinetic.com/en/library/edge/?source=SDK&id=ak_wwise_waapi_getschema.html \n
    ...
    def get_topics(self) -> tuple[str, ...]:
        """
        https://www.audiokinetic.com/en/library/edge/?source=SDK&id=ak_wwise_waapi_gettopics.html \n
