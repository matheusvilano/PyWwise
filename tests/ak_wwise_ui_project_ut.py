...
class AkWwiseUiProjectTest(unittest.TestCase):
    ...
    def test__create_project_with_platforms(self):
        ...
        pywwise_platform = PlatformInfo(name="PyWwise", base=EBasePlatform.WINDOWS)
        windows_platform = PlatformInfo(name="Windows", base=EBasePlatform.WINDOWS)
        android_platform = PlatformInfo(name="Android", base=EBasePlatform.ANDROID)
